...
#for machine in x86 x86-qemu rpi2 rpi3 rpi4 rpi4-64 rpi5 rock-pi-4 tinker-board tinker-board-s odroidn2l-hardkernel odroidn2plus-hardkernel; do
...
#for machine in odroidn2l-hardkernel odroidn2plus-hardkernel; do
#  kas build mld6-$machine.yml
#  kas shell mld6-$machine.yml -c "bitbake -k --runall build packagegroup-all"
#  kas shell mld6-$machine.yml -c "bitbake package-index"
#done
...
for machine in rpi4-64; do
  kas build mld6-$machine.yml
  kas shell mld6-$machine.yml -c "bitbake -k --runall build packagegroup-all"
  kas shell mld6-$machine.yml -c "bitbake package-index"
done

#for machine in rpi5; do
#  kas build mld6-$machine.yml
#  kas shell mld6-$machine.yml -c "bitbake -k --runall build packagegroup-all"
#  kas shell mld6-$machine.yml -c "bitbake package-index"
#done
